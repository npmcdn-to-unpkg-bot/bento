...
@endif
<a @if (auth()->user()) href="{{url('checkout')}}" @else href="#checkout" @endif class="fancybox floating-shoping-cart__checkout button button_red button_small">ОФОРМИТЬ ЗАКАЗ</a>